...
lib.read = (dir, filename, callback) => {
	...
	/*// This is temporary solution until I know how to fix the async read
	var fileData = fs.readFileSync(lib.baseDir + dir + '/' + filename + '.json',
		{ 'encoding': 'utf8', 'flag': 'r' });

	// Check the validity of file data read
	...
	// Return the result
	if (fileData) {
		// Parse data into object and return
